...
class TestTsRowFetcherNpDictTests(BaseTestClass):
    ...
    def testBackcastModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 0, mode='backcast', colsOrIndexes=['y1', 'y2'], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (3, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[1, 16], [2, 17], [3, 18]], dtype=torch.float32)))

    def testBackcastModeMakeTensorTrueColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 1, mode='backcast', colsOrIndexes='___all___', makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (3, 3))
        self.assertTrue(torch.equal(result, torch.tensor([[2, 17, 33], [3, 18, 34], [4, 19, 35]], dtype=torch.float32)))

    def testBackcastModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 1, mode='backcast', colsOrIndexes=['y1', 'y2'], makeTensor=False)
        self.assertTrue(isinstance(result, np.ndarray))
        self.assertEqual(result.shape, (3, 2))
        expectedResult = np.array([[2, 17], [3, 18], [4, 19]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testForecastModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 2, mode='forecast', colsOrIndexes=['y1', 'y2'], makeTensor=False)
        self.assertTrue(isinstance(result, np.ndarray))
        self.assertEqual(result.shape, (2, 2))
        expectedResult = np.array([[6, 21], [7, 22]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testForecastModeMakeTensorFalseColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 3, mode='forecast', colsOrIndexes='___all___', makeTensor=False)
        self.assertTrue(isinstance(result, np.ndarray))
        self.assertEqual(result.shape, (2, 3))
        expectedResult = np.array([[7, 22, 38], [8, 23, 39]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testForecastModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 3, mode='forecast', colsOrIndexes=['y1', 'y2'], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (2, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[7, 22], [8, 23]], dtype=torch.float32)))

    def testFullcastModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 0, mode='fullcast', colsOrIndexes=['y1', 'y2'], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (5, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[1, 16], [2, 17], [3, 18], [4, 19], [5, 20]], dtype=torch.float32)))

    def testFullcastModeMakeTensorTrueColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 1, mode='fullcast', colsOrIndexes='___all___', makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (5, 3))
        self.assertTrue(torch.equal(result, torch.tensor([[2, 17, 33], [3, 18, 34], [4, 19, 35], [5, 20, 36], [6, 21, 37]], dtype=torch.float32)))

    def testFullcastModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 1, mode='fullcast', colsOrIndexes=['y1', 'y2'], makeTensor=False)
        self.assertTrue(isinstance(result, np.ndarray))
        self.assertEqual(result.shape, (5, 2))
        expectedResult = np.array([[2, 17], [3, 18], [4, 19], [5, 20], [6, 21]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testSinglePointModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 2, mode='singlePoint', colsOrIndexes=['y1', 'y2'], makeTensor=False)
        self.assertTrue(isinstance(result, np.ndarray))
        self.assertEqual(result.shape, (1, 2))
        expectedResult = np.array([[3, 18]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testSinglePointModeMakeTensorFalseColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 3, mode='singlePoint', colsOrIndexes='___all___', makeTensor=False)
        self.assertTrue(isinstance(result, np.ndarray))
        self.assertEqual(result.shape, (1, 3))
        expectedResult = np.array([[4, 19, 35]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testSinglePointModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.npDict, 3, mode='singlePoint', colsOrIndexes=['y1', 'y2'], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (1, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[4, 19]], dtype=torch.float32)))
...
class TestTsRowFetcherTorchTensorTests(BaseTestClass):
    ...
    def testBackcastModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 0, mode='backcast', colsOrIndexes=[0, 1], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (3, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[1, 16], [2, 17], [3, 18]], dtype=torch.float32)))

    def testBackcastModeMakeTensorTrueColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 1, mode='backcast', colsOrIndexes='___all___', makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (3, 3))
        self.assertTrue(torch.equal(result, torch.tensor([[2, 17, 33], [3, 18, 34], [4, 19, 35]], dtype=torch.float32)))

    def testBackcastModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 1, mode='backcast', colsOrIndexes=[0, 1], makeTensor=False)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (3, 2))
        expectedResult = np.array([[2, 17], [3, 18], [4, 19]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testForecastModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 2, mode='forecast', colsOrIndexes=[0, 1], makeTensor=False)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (2, 2))
        expectedResult = np.array([[6, 21], [7, 22]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testForecastModeMakeTensorFalseColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 3, mode='forecast', colsOrIndexes='___all___', makeTensor=False)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (2, 3))
        expectedResult = np.array([[7, 22, 38], [8, 23, 39]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testForecastModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 3, mode='forecast', colsOrIndexes=[0, 1], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (2, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[7, 22], [8, 23]], dtype=torch.float32)))

    def testFullcastModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 0, mode='fullcast', colsOrIndexes=[0, 1], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (5, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[1, 16], [2, 17], [3, 18], [4, 19], [5, 20]], dtype=torch.float32)))

    def testFullcastModeMakeTensorTrueColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 1, mode='fullcast', colsOrIndexes='___all___', makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (5, 3))
        self.assertTrue(torch.equal(result, torch.tensor([[2, 17, 33], [3, 18, 34], [4, 19, 35], [5, 20, 36], [6, 21, 37]], dtype=torch.float32)))

    def testFullcastModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 1, mode='fullcast', colsOrIndexes=[0, 1], makeTensor=False)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (5, 2))
        expectedResult = np.array([[2, 17], [3, 18], [4, 19], [5, 20], [6, 21]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testSinglePointModeMakeTensorFalseColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 2, mode='singlePoint', colsOrIndexes=[0, 1], makeTensor=False)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (1, 2))
        expectedResult = np.array([[3, 18]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testSinglePointModeMakeTensorFalseColIndexesAll(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 3, mode='singlePoint', colsOrIndexes='___all___', makeTensor=False)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (1, 3))
        expectedResult = np.array([[4, 19, 35]])
        np.testing.assert_array_equal(expectedResult, result)
    ...
    def testSinglePointModeMakeTensorTrueColIndexesList(self):
        result = self.fetcher.getBackForeCastData(self.tensor, 3, mode='singlePoint', colsOrIndexes=[0, 1], makeTensor=True)
        self.assertTrue(isinstance(result, torch.Tensor))
        self.assertEqual(result.shape, (1, 2))
        self.assertTrue(torch.equal(result, torch.tensor([[4, 19]], dtype=torch.float32)))
#%% run test
